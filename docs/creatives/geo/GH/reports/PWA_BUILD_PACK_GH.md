...
**Подход:** ОБЛОЖКА ≠ СКРИНШОТЫ. Постер — отдельный (хук-арт); 3 скрина — одно широкое hero (GPT Image 2, реф=иконка) нарезано на 3 среза 9:16 = панорама (свайп 1→2→3 = одна сцена).

| Поле билдера | Источник | Файл |
|---|---|---|
| Иконка (App icon) | реальная `public.avif` (курица в кепке + машина + лого «CHICKEN ROAD 2») → 500×500 | `CR2_ICON_final.jpg` |
| Постер (Feature) | отдельный постер: курица+лого по центру, хук «CROSS. RISK. WIN BIG» + «CASH OUT TO MTN MOMO», машина/дорога. **16:9 1024×576** (НЕ срез скринов) | `CR2_FEATURE_final.jpg` |
| Скриншот 1 | левый срез hero-панорамы: «6X» + красная машина на дороге + монеты | `CR2_SCREEN1_final.jpg` |
| Скриншот 2 | центр hero-панорамы: курица + логотип «CHICKEN ROAD» | `CR2_SCREEN2_final.jpg` |
| Скриншот 3 | правый срез hero-панорамы: «20X» + «BIG WIN» + монеты | `CR2_SCREEN3_final.jpg` |

> Порядок свайпа скринов: 6X/машина → курица/лого → 20X/BIG WIN (= одна сцена). Постер — отдельная картинка с хуком. EVERGREEN: множители/«BIG WIN» — игровая подача, без бонуса/сумм-подарков. Чужих лого нет.
