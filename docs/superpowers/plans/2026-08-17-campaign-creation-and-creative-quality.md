...
**Про эталоны 40% / 10%.** Отраслевые источники сходятся на формуле hook rate =
3-секундные просмотры ÷ показы, но расходятся в определении hold rate: ThruPlay ÷ 3-сек,
15-сек ÷ 3-сек и 15-сек ÷ показы дают разные шкалы. Официального эталона у Meta нет — hook
rate там вообще не метрика, а пользовательская формула. Поэтому в треке B знаменатель
фиксируется в коде явно и подписывается в UI, иначе «10%» будет значить разное в разные дни.
...
### Task B3: Hook rate и hold rate с явным знаменателем
...
### 2. Решить, какой знаменатель у hold rate

Отрасль считает его тремя способами, и от выбора зависит, что значит твоё «более 10%»:

- **ThruPlay ÷ 3-сек просмотры** — типичные значения 40-50%, порог 10% при нём почти
  недостижимо низкий;
- **15-сек ÷ 3-сек** — типичные 20-25%;
- **15-сек ÷ показы** — самые низкие числа, к порогу 10% ближе всего.
