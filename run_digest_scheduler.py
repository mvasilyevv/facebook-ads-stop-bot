# -*- coding: utf-8 -*-
"""Container entrypoint для digest_scheduler."""
...
from apps.digest_scheduler.main import _get_database_url, main_loop
...
if __name__ == "__main__":
    ...
    start_worker_metrics_server("digest_scheduler")
