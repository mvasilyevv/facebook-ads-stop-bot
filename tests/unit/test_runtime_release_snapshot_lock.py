...
def _runtime_environment(
    ...
    _write(
        ...
        (
            ...
            "PROMETHEUS_REMOTE_WRITE_URL=https://monitor.example/api/v1/write\n"
            "LOKI_WRITE_URL=https://monitor.example/loki/api/v1/push\n"
            "TEMPO_OTLP_HTTP_URL=https://monitor.example/otlp\n"
