 ...
 *
 * Портировано из design_handoff/components.jsx (PulseDot). Использует класс
 * .wp-dot из tokens.css (keyframes fbPulse поверх currentColor). Negative
 ...
 *
 * Цвет передаётся как CSS-значение (var(--success)/var(--warning)/…): задаётся
