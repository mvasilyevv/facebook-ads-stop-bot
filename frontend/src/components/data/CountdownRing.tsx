/**
 * CountdownRing + PausedRing — кольца для scan-кластера Dashboard.
 *
 * Портировано из design_handoff/dashboard-shared.jsx (CountdownRing/PausedRing).
 *   - CountdownRing: SVG-кольцо обратного отсчёта (stroke-dashoffset анимируется),
 *     по центру — оставшиеся секунды.
...
interface CountdownRingProps {
  /** Текущее значение (секунды до скана / прогресс). */
  value: number;
  /** Максимум (interval) для расчёта доли заполнения. */
  max: number;
  /** Размер кольца в px. */
  size?: number;
