/** Временный обход всех экранов ради скриншотов: не проверка, а инвентарь. */
...
const SCREENS: Array<{ slug: string; path: string }> = [
  ...
  { slug: "14-remote-desktop", path: "/remote-desktop" },
...
for (const screen of SCREENS) {
  test(`@audit ${screen.slug}`, async ({ page }, testInfo) => {
