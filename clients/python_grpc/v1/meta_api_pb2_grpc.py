...
def add_MetaApiServiceServicer_to_server(servicer, server):
    ...
    server.add_registered_method_handlers('fb_agent.meta_api.v1.MetaApiService', rpc_method_handlers)
...
class MetaApiService(object):
    ...
    @staticmethod
    def ExecuteGraphCallV5(request,
            target,
            options=(),
    ...
    @staticmethod
    def CheckMetaApiHealth(request,
            target,
            options=(),
            channel_credentials=None,
            call_credentials=None,
