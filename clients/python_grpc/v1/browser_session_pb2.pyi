...
class OpenCabinetTabsRequest(_message.Message):
    ...
    def __init__(self, session_id: _Optional[str] = ..., ad_account_ids: _Optional[_Iterable[str]] = ...) -> None: ...

class OpenCabinetTabsResponse(_message.Message):
    __slots__ = ("results",)
    RESULTS_FIELD_NUMBER: _ClassVar[int]
    results: _containers.RepeatedCompositeFieldContainer[CabinetTabResult]
    def __init__(self, results: _Optional[_Iterable[_Union[CabinetTabResult, _Mapping]]] = ...) -> None: ...
...
class CabinetTabResult(_message.Message):
    ...
    url: str
    error: str
    def __init__(self, ad_account_id: _Optional[str] = ..., opened: bool = ..., url: _Optional[str] = ..., error: _Optional[str] = ...) -> None: ...

class StartBrowserRequest(_message.Message):
    __slots__ = ("vision_x_token", "vision_api_url", "vision_profile_id", "vision_folder_id", "viewport_width", "viewport_height")
    ...
    viewport_width: int
    viewport_height: int
    def __init__(self, vision_x_token: _Optional[str] = ..., vision_api_url: _Optional[str] = ..., vision_profile_id: _Optional[str] = ..., vision_folder_id: _Optional[str] = ..., viewport_width: _Optional[int] = ..., viewport_height: _Optional[int] = ...) -> None: ...
...
class StartBrowserResponse(_message.Message):
    ...
    def __init__(self, session_id: _Optional[str] = ..., profile: _Optional[_Union[VisionProfile, _Mapping]] = ..., initial_page_url: _Optional[str] = ...) -> None: ...
...
class VisionProfile(_message.Message):
    ...
    profile_id: str
    cdp_port: int
    def __init__(self, folder_id: _Optional[str] = ..., profile_id: _Optional[str] = ..., cdp_port: _Optional[int] = ...) -> None: ...
...
class RecoverBrowserProfileRequest(_message.Message):
    __slots__ = ("vision_x_token", "vision_api_url", "vision_profile_id", "vision_folder_id", "maintenance_owner", "capability_expires_at", "capability_nonce", "capability_signature")
    VISION_X_TOKEN_FIELD_NUMBER: _ClassVar[int]
    VISION_API_URL_FIELD_NUMBER: _ClassVar[int]
    VISION_PROFILE_ID_FIELD_NUMBER: _ClassVar[int]
    VISION_FOLDER_ID_FIELD_NUMBER: _ClassVar[int]
    ...
    def __init__(self, vision_x_token: _Optional[str] = ..., vision_api_url: _Optional[str] = ..., vision_profile_id: _Optional[str] = ..., vision_folder_id: _Optional[str] = ..., maintenance_owner: _Optional[str] = ..., capability_expires_at: _Optional[int] = ..., capability_nonce: _Optional[str] = ..., capability_signature: _Optional[str] = ...) -> None: ...
