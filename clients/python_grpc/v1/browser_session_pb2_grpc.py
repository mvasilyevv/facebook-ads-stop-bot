...
def add_BrowserSessionServiceServicer_to_server(servicer, server):
    ...
    server.add_registered_method_handlers('fb_agent.browser_session.v1.BrowserSessionService', rpc_method_handlers)
...
class BrowserSessionService(object):
    ...
    @staticmethod
    def RecoverBrowserProfileUnderMaintenance(request,
            target,
            options=(),
            channel_credentials=None,
            call_credentials=None,
