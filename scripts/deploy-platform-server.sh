...
desktop_kasmvnc_image="$(sed -n 's/^DESKTOP_KASMVNC_IMAGE=//p' "$RELEASE_ENV" | tail -n 1)"
for image in "$desktop_webtop_image" "$desktop_kasmvnc_image"; do
