...
import { MiniSeverityBadge } from "./OperatorAds";
import {
...
/**
 * Экран инцидента: маршрут `/incidents/$incidentId` и deep-link `/open`
 * открывают один и тот же компонент, поэтому он живёт вне `routes/`
 * (issue #349).
 */
