...
/**
 * Экран объявления. Живёт вне `routes/`, потому что его открывают два входа:
 * маршрут `/ads/$fbAdId` и deep-link `/open`. Пока компонент лежал в
 * route-файле, статический импорт из `/open` тянул его — и весь путь команды
 * объявления — в стартовый чанк мини-приложения (issue #349).
 */
