...
уходит в парковку, а не в текущий уровень. Живая привязка карточек к уровням —
issue [#268](https://github.com/mvasilyevv/facebook-ads-stop-bot/issues/268).
...
8. Merge, production release и денежные действия остаются за человеком.
