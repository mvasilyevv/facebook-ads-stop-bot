...
exports.mapEffectiveStatus = mapEffectiveStatus;
exports.buildScannedRow = buildScannedRow;
exports.buildScannedRows = buildScannedRows;
...
function mapEffectiveStatus(status) {
...
function buildScannedRow(am, meta = {}) {
    const a = am.atomic;
    return {
        fb_ad_id: am.adId,
...
function buildScannedRows(merged, adMeta) {
    const out = [];
...
//# sourceMappingURL=am-join.js.map