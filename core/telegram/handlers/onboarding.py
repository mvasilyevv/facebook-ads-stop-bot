...
async def handle_help(
    *,
    ...
    txt = "\n".join(
        [
            fmt.heading("📖 Команды бота", 2),
            fmt.heading("⏯ Массовые действия", 4),
            ...
            fmt.heading("🤖 AI-ассистент (владелец)", 4),
